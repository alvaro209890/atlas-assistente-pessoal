...
export const navItems: NavItem[] = [
  ...
  { id: 'chats', label: 'Conversas', description: 'Monitoramento do WhatsApp', icon: MessageCircle, section: 'main', shortcut: 'G W' },
...
export const viewMeta: Record<NavId, { title: string; eyebrow: string; description: string; icon: LucideIcon }> = {
  ...
  chats: { title: 'Conversas monitoradas', eyebrow: 'WhatsApp', description: 'Escolha quais conversas o Atlas acompanha para gerar tarefas e lembretes.', icon: MessageCircle },
